...
overflow="scroll";
style=menuStyle2;
aI("text=Microfinance;url=about.html#microfinance;")
aI("text=Sia N'Son;url=about.html#mission;")
aI("text=Empoyees;url=employees.html;")
...
aI("text=How to apply;url=apply.html;");
}
...
style=menuStyle2;
aI("text=Jobs;url=careers.html#jobs;");
aI("text=Internships;url=careers.html#internships;");
}
