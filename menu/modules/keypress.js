/*
   Milonic DHTML Menu Keypress Module  keypress.js version 2.7 - March 27 2008
...
function getMenuByKeyU(e){
	...
	//alert(chr(_jsk) +" - " + e.ctrlKey)
	
	if(_jsk==hotKey_F_Number+111)h$(getNextMmItem())
	if(e.ctrlKey && chr(_jsk)==hotkey_Ctrl_Char)h$(getNextMmItem()) // if ctrl and hotkey_Ctrl_Char is pressed
