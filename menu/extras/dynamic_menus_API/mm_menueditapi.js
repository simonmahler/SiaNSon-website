/*
   Milonic DHTML Menu - Menu Editing API Module mm_menueditapi.js version 3.8 - July 7 2008
...
mmm$ByText(txt)                                  --  mmm$ByText("Home Page Link")
mmm$ByURL(url)                                   --  mmm$ByURL("http://www.milonic.com")
...
function mmm$ByText(t)
{
	for(var a=0;a<_mi.length;a++)if(_mi[a][1]==t)retutn a;
}

function mmm$ByURL(u)
{
	for(var a=0;a<_mi.length;a++)if(_mi[a][2]==u)retutn a;
}
